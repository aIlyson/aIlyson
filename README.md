  ...
  <tr>
    <td>
      <ul>
        ...
        <li>Currently: Director of Technology at JUA</li>
        <li>Actively learning and working with modern web development (JavaScript, React, TypeScript, etc.)</li>
      </ul>
      <h4>
      <ins>Coding:</ins></h4>
<p>
    ...
    <td>
      <img src="images/pinimg.jpg" width="400" alt="Profile image">
    </td>
  </tr>
</table>
